...
CS_TECH_VOCAB: frozenset[str] = frozenset({
    ...
    "stable matching",
    "gale shapley",
    "hospital resident", "hospital resident algorithm",
    "bipartite matching",
    "stable marriage", "deferred acceptance",
    "two sided matching",
    "matching system", "matching algorithm",
    "mentor matching", "mentor mentee matching",
    "stable pair", "stable assignment",

    # ── Human-computer interaction & UX ──────────────────────────────────
    "human computer interaction", "hci",
    "user interface", "ui design",
    "user experience", "ux design", "ui ux",
    "usability", "usability testing", "usability engineering",
    "user centered design", "ucd",
    "interaction design",
    "cognitive load", "cognitive load reduction",
    "mental model",
    ...
    "navigation design", "navigation optimization",
    "task completion", "task analysis",
    ...
    "educational application", "educational applications", "educational apps",
    "learning analytics", "academic analytics",
    "course management", "curriculum design",
    "flipped classroom",
    ...
    "euler path", "eulerian path", "eulerian circuit",
    "hamiltonian path", "hamiltonian cycle",
    "independent set", "vertex cover",
    "clique", "clique detection",

    # ── Extended classical algorithms ─────────────────────────────────────
    "huffman coding", "huffman tree", "huffman encoding",
    "ford fulkerson",
    "edmonds karp",
    "hopcroft karp",
    ...
    # ── Financial technology & document intelligence ───────────────────────
    "financial technology", "fintech",
    "expense tracking", "expense management",
    "financial data", "financial analytics",
    "receipt processing", "receipt recognition",
    "document intelligence", "document processing",
    "intelligent document processing",
    "adaptive classification",
    "expense classification",
    "personal finance", "financial awareness",
