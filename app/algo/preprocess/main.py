...
if __name__ == "__main__":
    ...
    from matching import generate_preferences, hospital_resident, hospital_resident_mentor_optimal, pick_fairer_matching, verify_stability
    ...
    final_assignment, method = pick_fairer_matching(
        mentors, mentees, assignment_mo, assignment_meo, mentee_prefs, mentor_prefs
    )

    print("\n🔍 Step 5d: Verifying stability...")
    is_stable = verify_stability(
        final_assignment, mentors, mentees, mentee_prefs, mentor_prefs, hospital_capacity
    )
    ...
    from scoring import get_matched_keywords
    match_records = []
    ...
    # ── Output structured JSON log for Node.js to parse ──────────
    log_output = {
        "success": True,
    ...
    # print JSON log with a special marker so Node.js can parse it
