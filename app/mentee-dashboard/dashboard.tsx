                ...
                <div className="p-8">
                    <div className="grid lg:grid-cols-3 gap-6 mb-8">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900">
                                                Dr. Marc Lawrence Tamayo
                                            </h3>
                                            <p className="text-gray-600">mltamayo@fit.edu.ph</p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-800">
                                                Published a paper about gale-shapley algorithm
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div>
                            <MatchScoreCard
                                score={0.9}
                                keywords={["NLP, AI, Computer Vison"]}
                            />
                        </div>
                    </div>
                    {/* For logic later
